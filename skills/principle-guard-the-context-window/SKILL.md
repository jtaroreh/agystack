...
- **Leverage Antigravity Artifacts.** Offload dense technical specifications, test receipts, comparison tables, and visual diffs to Antigravity Artifacts (`<appDataDir>/brain/<conversation-id>/`). Link to them cleanly in chat rather than inlining large markdown payloads.
