...
4. Pick the worker model from `swarm workers` in `~/.gemini/config/plugins/pstack/rules/pstack-models.md` when present. Otherwise use `grok-4.6-fast-xhigh`. For a model race, name each arm's model up front.
