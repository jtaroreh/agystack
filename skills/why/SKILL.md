...
Before spawning investigators, list the available MCPs from the Antigravity environment. Use the available-tools map, active plugins, or MCP configuration (`mcp_config.json`).
