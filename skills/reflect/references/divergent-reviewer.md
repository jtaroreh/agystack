...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.gemini/config/skills/`, or plugin-installed paths under `~/.gemini/config/plugins/`)
