...
**Reply:** point to `walkthrough.md` and the PR. Summarize what you built, what you chose and why, and open decisions in concise declarative sentences. Tables and diagrams live in the artifacts.
