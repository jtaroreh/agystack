...
1. Draft the skill under `skills/<name>/SKILL.md` (or `.agents/skills/<name>/SKILL.md` for project-local skills) with YAML frontmatter (`name` and `description`). Follow the Antigravity customization guidelines.
