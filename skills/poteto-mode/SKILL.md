...
You own every subagent's work. Review the diff and write your own summary, don't pass through what it said. Use `send_message` to iterate with an active worker on sequential adjustments to preserve context and reduce prompt overhead. When closing a major phase or starting a distinct unit of work, spawn a fresh subagent with consolidated scope rather than resume-chaining. A second opinion is the same prompt against a different model. Agreement is high-signal.
