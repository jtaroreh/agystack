...
The panel comes from your [`/setup-agystack`](../../skills/setup-agystack/SKILL.md) configuration, and you can adjust it per task. Ask for more candidates when the decision matters, fewer when it doesn't:
