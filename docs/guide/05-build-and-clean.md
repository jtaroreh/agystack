...
The [Opening a PR playbook](../../skills/poteto-mode/playbooks/opening-a-pr.md) runs [`/deslop`](../../skills/deslop/SKILL.md) on the diff before each commit and applies [`/unslop`](../../skills/unslop/SKILL.md) to the PR description and commit bodies. `/deslop` removes narrating comments, unsupported guards, defensive try/catches, dead compatibility paths, and unrelated edits directly from code and diffs.
