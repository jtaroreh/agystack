...
[`/poteto-mode`](./skills/poteto-mode/SKILL.md) works extremely well with Antigravity's `/loop` and `/goal` commands. you can make agents work for many hours without sacrificing rigor.
